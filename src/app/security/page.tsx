  ...
  return (
    <main style={{ maxWidth: 700, margin: '0 auto', padding: '2rem' }}>
      ...
      <ul style={{ marginBottom: '2rem' }}>
        ...
        <li>
          Data residency: All customer data is stored in the region selected at
          onboarding.
        </li>
      </ul>
      <h2>Subprocessors</h2>
      ...
      <p>
        <a
          href="https://quarrycrm.com/legal/dpa.pdf"
          target="_blank"
      ...
      <p style={{ marginTop: '2rem', fontSize: '0.95em', color: '#555' }}>
        ...
        <a href="mailto:security@quarrycrm.com">security@quarrycrm.com</a>.
      </p>
    </main>
  )
}

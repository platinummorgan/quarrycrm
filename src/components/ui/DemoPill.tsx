...
export function DemoPill({
  ...
  if (variant === 'large') {
    return (
      <div className="border-y border-yellow-200 bg-gradient-to-r from-yellow-50 to-orange-50 dark:border-yellow-800 dark:from-yellow-950/20 dark:to-orange-950/20">
        <div className="container mx-auto max-w-7xl px-4 py-3">
          <div className="flex items-center justify-center gap-3 text-sm">
            ...
            <a
              href="/signup"
              className="font-medium text-yellow-900 underline transition-colors hover:text-yellow-700 dark:text-yellow-100 dark:hover:text-yellow-300"
            >
  ...
  return (
    <Badge
      variant="outline"
      className="gap-1.5 border-yellow-300 bg-yellow-50 px-2.5 py-0.5 text-yellow-700 dark:border-yellow-700 dark:bg-yellow-950/30 dark:text-yellow-400"
    >
      <Eye className="h-3 w-3" />
      <span className="text-xs font-medium">Read-only Demo</span>
    </Badge>
  )
}

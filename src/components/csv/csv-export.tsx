...
export function CsvExport({ onExport }: CsvExportProps) {
  ...
  const availableColumns = selectedEntityType
    ? ENTITY_COLUMNS[selectedEntityType]
    : []
      ...
      <CardContent>
        {isDemo ? (
          <div className="py-8 text-center text-muted-foreground">
            ...
            <p className="mb-2 text-lg font-medium">Export Disabled</p>
            <p>
              Read-only demo. Export functionality is not available in demo
              mode.
            </p>
          </div>
        ) : (
          ...
          >
            ...
            {selectedEntityType && (
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    form.setValue('format', value as 'csv' | 'json')
                  }
                >
                  <SelectTrigger>
                    <SelectValue />
            ...
            {selectedEntityType && (
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() => {
                        const requiredKeys = availableColumns
                ...
                <div className="grid max-h-60 grid-cols-2 gap-3 overflow-y-auto rounded-lg border p-3">
                ...
                <div className="text-sm text-muted-foreground">
                  {selectedColumns?.length || 0} of {availableColumns.length}{' '}
                  columns selected
                </div>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-lg border bg-muted/50 p-3 text-sm text-muted-foreground">
                Filters will be available in a future update. Currently exports
                all records.
              </div>
            </div>
